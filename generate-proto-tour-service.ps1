# PowerShell skripta za generisanje protobuf fajlova - Tour Service

Write-Host "Generisanje protobuf fajlova za Tour Service..." -ForegroundColor Green

# Pozicioniranje u tour-service direktorijum
...
if ($LASTEXITCODE -eq 0) {
    ...
    Get-ChildItem -Path "gen\pb-go\*.pb.go" | ForEach-Object { Write-Host "  - $($_.Name)" -ForegroundColor White }
